...
@Slf4j
@Controller
public class UpdatePrivacyController extends BaseController {
...
//        binder.registerCustomEditor((Class<List<ItemKine>>)(Class<?>)List.class, orderNoteEditor);
	 ...
	 * @return
	 */
	@RequestMapping(value = { "MyPrivacyUpdate" }, method = RequestMethod.GET)
	public ModelAndView updatePrivacy(@RequestParam(required = false) String profileImagePrivacy,
		...
		ModelAndView mav = new ModelAndView("redirect:/MyPrivacy");
